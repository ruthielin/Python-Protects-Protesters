...
full_RISK = pd.read_csv('/Users/ruthielin/Downloads/(USE) BackUp (RISK ANALYZED)- Usable Statistics.csv', skiprows=1,
                        delimiter=',')
...
plt.title('Current RISK Level in County')
axes = plt.gca()
axes.set_xlim([0, 100])
